...
public class InnerBuilder_Mouthology {
    public static void main(String[] args) {
        //if we want to change fields - Person.Builer buildername = Person.Builder(); - and use it instead
        //but we will have to create custom builders for each object
        Person professor = Person.builder()
                ...
                .setGeography(true)
                .getPerson();
        System.out.println(professor.isGeography());

        Person sailor = Person.builder()
                .setEscapology(true)
                .getPerson();
        System.out.println(sailor.isEscapology());
        System.out.println(sailor.isEcology());
    }
}
