...
public class ZodiacSigns {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        ResourceBundle bundleRU = ResourceBundle.getBundle("Signs", localeRU);
        ResourceBundle bundleEN = ResourceBundle.getBundle("Signs", localeEN);
        
        String signOfZodiacRU = bundleRU.getString(signs[sign]);
        String signOfZodiacEN = bundleEN.getString(signs[sign]);        
        System.out.println(bundleRU.getString("you")+signOfZodiacRU);
        System.out.println(bundleEN.getString("you")+signOfZodiacEN);
