...
public class Flyweight {
    public static void main(String[] args) {
        ...
        System.out.println(micelium.getMushroom(MushroomType.Honey,1,1).toDetailString());
        System.out.println(micelium.getMushroom(MushroomType.Honey,2,1).toDetailString());
    }
